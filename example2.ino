...
void loop(void)
{
  ...
  sensors_event_t compassData , angVelocityData , linearAccelData;
  bno.getEvent(&compassData, Adafruit_BNO055::VECTOR_MAGNETOMETER);
  //bno.getEvent(&angVelocityData, Adafruit_BNO055::VECTOR_GYROSCOPE);
  //bno.getEvent(&linearAccelData, Adafruit_BNO055::VECTOR_LINEARACCEL);

  printEvent(&compassData);
...
double KonversiKeHeading(){
  long x = micros();
  // Calculate heading
  float heading = atan2(yf, xf);
